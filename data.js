...
{ 
  ...
  { kicker: "Introduction", lead: "Chaque blessure émotionnelle coupe d’un appui fondamental.", text: "Quand la blessure s’active, la personne perd plus facilement l’accès à une ressource intérieure essentielle. Le chemin de transformation consiste alors à se reconnecter à une intelligence déjà présente en soi, mais momentanément voilée, blessée ou déformée par l’expérience. Ces intelligences ouvrent un passage concret vers une présence plus juste, plus libre et plus incarnée." },
  ...
  { kicker: "L’intelligence émotionnelle", lead: "Axe de reconnexion : l’amour — Blessure associée : l’abandon", text: "L’abandon touche le lien, la présence, le manque affectif et la sécurité du cœur. La personne peut chercher l’amour à l’extérieur, craindre le vide, se sentir incomplète sans présence rassurante et dépendre du lien pour se sentir vivante. Se reconnecter à l’amour, c’est revenir à une qualité de présence plus stable, plus douce et plus libre." },    { kicker: "L’intelligence intellectuelle", lead: "Axe de reconnexion : la capacité de discernement — Blessure associée : l’injustice", text: "L’injustice rigidifie le mental, le rapport à soi et la manière de penser le réel. La personne peut se couper de sa souplesse intérieure, de sa clarté, de son libre arbitre et de son esprit critique, puis rester enfermée dans le contrôle, l’exigence ou le juge intérieur. Se reconnecter à sa capacité de discernement, c’est retrouver une pensée juste, de la clarté, de la nuance et une lecture plus fine de ce qui est vécu." },
  { kicker: "L’intelligence corporelle", lead: "Axe de reconnexion : la vie — Blessure associée : le rejet", text: "Le rejet touche profondément l’incarnation terrestre. La personne peut se couper de son corps, de sa présence, de son ancrage, de sa place et de son droit d’être là. Se reconnecter à la vie, c’est revenir dans le corps, habiter sa présence, reprendre sa place et cesser de disparaître intérieurement." },
  { kicker: "L’intelligence instinctive", lead: "Axe de reconnexion : la dignité — Blessure associée : l’humiliation", text: "L’humiliation touche la valeur personnelle, le rapport au corps, aux besoins, au plaisir, à la liberté d’être et au droit de recevoir. La personne peut s’oublier, se sacrifier, se rabaisser, faire pour les autres même lorsque cela n’est pas demandé, et aller au-delà des besoins des autres comme si elle devait porter davantage qu’eux. Se reconnecter à sa dignité, c’est revenir au respect intérieur, au droit d’honorer ses besoins, de recevoir sans honte, de ressentir sans culpabilité et de poser ses limites avec simplicité." },
  { kicker: "Conclusion", lead: "Se reconnecter, ce n’est pas devenir quelqu’un d’autre.", text: "C’est retrouver en soi ce qui a toujours été vivant, mais que les blessures ont parfois enfoui ou mis à distance. Plus la personne se reconnecte à la foi, à l’amour, à sa capacité de discernement, à la vie et à sa dignité, plus elle se reconnecte à tout son potentiel." },
] 
},
...
},
{
...

  {
    ...
    subtitle: "Comportement d’infériorité",
      grid: [
        ...
        ["Sentiments possibles", "Solitude, vide, invisibilité, repli, mélancolie, effacement, isolement, coupure, déconnexion, absence à soi."],
        ...
        ["Rapport au non / aux limites", "La personne ne dit pas toujours non clairement. Elle peut éviter, esquiver, se retirer, disparaître du lien ou s’éloigner silencieusement plutôt que d’affirmer sa limite. Dans cette blessure, c’est souvent elle qui part."], 
...

  {
   ...
   grid: [
     ...
     ["Empathie blessée", "Confond souvent empathie et fusion. Donne beaucoup, cherche à rester reliée, capte fortement les signes de distance ou de retrait, et peut se tourner vers l’autre dans l’espoir d’éviter d’être abandonnée."],
     ["Comportements dysfonctionnels", "Peur de la solitude, dépendance affective, recherche excessive de soutien, besoin d’attention, attente de réponses, sensibilité au silence, difficulté à exister sans l’aval ou la présence rassurante d’autrui, dramatisation plus marquée dans les épreuves, difficulté à avancer seule. Le vide intérieur peut alors pousser à s’accrocher, réclamer, se plaindre, dépendre ou chercher sans cesse des signes de lien."],
     ["Rapport au non / aux limites", "La personne a souvent de la difficulté à dire non lorsqu’elle craint de perdre le lien, de décevoir ou de se retrouver seule. Elle peut dire oui pour garder la relation, même lorsque cela ne lui convient pas vraiment."], 
     ["Valeurs", "Amour, proximité, lien, chaleur humaine, partage."],
     ["Croyances limitantes", "« Je finis toujours seul. » « Personne ne reste jamais avec moi. » « J’ai besoin des autres pour aller bien. » « Sans soutien, je n’y arriverai pas. » « Si l’autre s’éloigne, c’est que je ne compte pas. »"],
     ["Croyances expansives", "« Je peux me sentir complet même lorsque je suis seul. » « Je peux créer des liens stables et nourrissants. » « Je peux avancer avec mes propres ressources. » « Ma valeur reste entière même lorsque l’autre s’éloigne. » « Je peux vivre le lien sans dépendre de la présence constante de l’autre. »"],
     ["Axe de reconnexion", "Se reconnecter à l’amour."],
     ["Incarner son plein potentiel", "Quand cette blessure s’apaise, l’être peut incarner l’amour, la présence, la tendresse, la qualité de lien, la capacité à demander juste, à recevoir sans se perdre et à rester relié sans dépendre. La relation devient plus libre, plus stable et plus nourrissante."],
...

  {
    ...
    grid: [
     ...
     ["Sentiments possibles", "Honte, indignité, gêne, embarras, malaise, nausée, dégoût de soi, remords, auto-dévalorisation, écœurement."],
     ["Origine", "Blessure liée à la honte, à l’humiliation et au fait d’être diminué dans son rapport au corps, au plaisir, aux besoins ou à la liberté d’être. Elle se construit lorsque l’enfant vit une attitude répressive, culpabilisante ou dévalorisante autour de ce qu’il ressent, de ce qu’il aime, de ce qui lui fait du bien, de son corps ou de ses besoins. L’humiliation atteint profondément la dignité, la valeur personnelle et le respect de soi dans la relation."],
     ["Âge d’ancrage", "Souvent entre 1 et 3 ans. Cette blessure peut se structurer à un moment très lié au corps, à la liberté corporelle, au plaisir, à la honte et au développement sensoriel."],
     ["Masque / fonctionnement", "Masque du masochiste. La personne peut se rabaisser, se sacrifier, se punir, se charger et s’oublier elle-même. Elle cherche facilement sa valeur dans l’utilité, le service, la générosité et la capacité à porter pour les autres. Elle peut faire pour les autres même lorsque cela n’est pas demandé, aller au-delà de leurs besoins, prendre sur elle les responsabilités et se rendre constamment utile pour éviter l’espace libre, la liberté ou le face-à-face avec elle-même. Elle supporte difficilement de rester simplement avec elle-même, de recevoir sans contrepartie, d’honorer son propre plaisir ou de s’autoriser du confort sans se sentir mal à l’aise."],
     ["Empathie blessée", "La personne ressent fort, mais la honte freine l’expression juste de ce qu’elle vit. Elle peut rapidement se sentir en faute, excuser les autres, minimiser ce qu’elle ressent et laisser ses propres besoins passer après ceux de l’entourage. Elle donne, répare, arrange et porte facilement davantage que sa juste part, comme si demander pour elle-même, recevoir ou honorer son propre besoin risquait de paraître égoïste, déplacé ou sans cœur. Elle peut aussi avoir du mal à identifier ce qui lui ferait du bien, comme si son bien-être, son confort ou le fait de recevoir demandaient déjà une justification."],
     ["Comportements dysfonctionnels", "Sacrifice, oubli de soi, remords, auto-dévalorisation, service excessif, aide non demandée, anticipation des besoins des autres, difficulté à recevoir, difficulté à demander, difficulté à s’autoriser le plaisir et le confort, retenue sensuelle, nourriture refuge, sexualité compensatoire, auto-sabotage, retour du compliment, gêne à prendre sa place ou à reconnaître sa valeur. Quand la blessure s’active, la personne peut se faire passer après tout le monde, se charger de trop, se diminuer, se rendre indispensable, puis se sentir envahie, sale, honteuse, nauséeuse ou dégoûtée d’elle-même."],
     ["Rapport au non / aux limites", "La personne a souvent beaucoup de difficulté à dire non lorsqu’elle se sent obligée d’aider, de porter ou de se rendre utile. Elle peut dire oui alors que cela ne lui convient pas, se sacrifier, puis s’en vouloir de ne pas avoir posé sa limite."],
     ["Valeurs", "Respect, dignité, authenticité, générosité juste, douceur."],
     ["Croyances limitantes", "« Je dois me sacrifier pour les autres. » « Mes besoins passent après. » « Je prends trop de place quand je demande. » « Recevoir me met mal à l’aise. » « Je ne mérite pas d’être heureux. »"],
     ["Croyances expansives", "« Mes besoins ont de la valeur. » « Je peux recevoir sans culpabiliser. » « Je mérite le respect et la joie de vivre. » « Je peux être au service sans me sacrifier. » « Je peux poser mes limites avec simplicité. »"],
     ["Axe de reconnexion", "Se reconnecter à sa dignité."],
     ["Incarner son plein potentiel", "Quand cette blessure s’apaise, l’être peut incarner une générosité juste, un service aligné, une présence respectueuse de soi, une relation plus libre au corps et une capacité à donner sans s’oublier. La personne peut alors honorer ses besoins, recevoir avec plus de simplicité, poser ses limites avec douceur et rester profondément digne dans le lien."],
     ["Guérison", "Quand la blessure d’humiliation s’apaise, la personne écoute davantage ses besoins avant ceux des autres, porte moins sur ses épaules, se sent plus libre, demande plus simplement, reçoit avec moins de honte et cesse progressivement de se rendre utile pour avoir une place. Elle retrouve un rapport plus apaisé à son corps, à ses désirs, à ses limites, à son confort et à sa valeur."],
   ],
  },
...
grid: [
  ...
  ["Empathie blessée", "Sous l’effet de la blessure de trahison, l’autre est facilement filtré à travers le contrôle, la vérification ou le test permanent. L’écoute perd en disponibilité, car la personne reste centrée sur sa propre lecture de la situation. Elle croit voir clair, alors qu’elle cherche surtout à garder la main."],
  ...
  ["Rapport au non / aux limites", "La personne dit plus facilement non, mais souvent avec exigence, contrôle ou volonté de garder la main. Elle supporte mal qu’on lui impose quelque chose et peut poser ses limites de manière tranchée, autoritaire ou dominatrice."], 
  ["Valeurs", "Loyauté, fidélité, vérité, fiabilité, engagement, clarté, cohérence, sécurité, protection, force, famille."],
  ["Croyances limitantes", "« Les autres vont forcément me trahir. » « Je dois garder le contrôle. » « On ne peut faire confiance à personne. » « Si je relâche, je serai déçu. » « Je dois vérifier pour éviter d’être trompé. »"],
  ["Croyances expansives", "« Je peux rester clair sans contrôler. » « Je peux faire confiance avec discernement. » « Je peux poser un cadre sans dominer. » « Je peux rester fort sans imposer. » « Je peux protéger sans prendre le pouvoir sur l’autre. »"],
...

  {
   ...
   grid: [
     ...
     ["Empathie blessée", "La personne n’est plus vraiment à l’écoute d’elle-même. Elle se coupe de ce qu’elle ressent dans son corps, se dissocie, se contrôle, se retient et reste davantage dans la tête que dans le ressenti. Elle se débrouille seule, ne demande rien, et supporte mal qu’on lui donne un conseil qu’elle n’a pas demandé. L’accueil de l’autre passe alors par un filtre froid ou exigeant. Elle peut aussi juger les personnes qui jugent, tout en gardant beaucoup à l’intérieur."],
     ["Comportements dysfonctionnels", "Perfectionnisme, rigidité, retenue émotionnelle, hyper-contrôle sur soi, travail excessif, difficulté à lâcher, critique intérieure, froideur, fermeture, comparaison, tension corporelle, déconnexion du corps, dialogue mental critique, indépendance excessive, refus d’aide, refus du conseil non demandé. Quand la blessure est activée, la personne peut couper court, mettre fin à l’échange, exiger que l’autre parte, le faire sortir de son espace et vouloir qu’on la laisse tranquille, pour éviter que sa colère déborde et que l’autre la subisse."],
     ["Rapport au non / aux limites", "La personne peut dire non, mais souvent de manière froide, nette ou coupée. Elle supporte difficilement l’intrusion, le conseil non demandé ou le fait qu’on décide à sa place. Quand elle est touchée, elle ferme l’accès plus qu’elle n’explique."], 
     ["Valeurs", "Justice, équité, intégrité, vérité."],
     ["Croyances limitantes", "« Je dois toujours prouver ma valeur. » « Je ne peux pas me montrer imparfait. » « Je ne dois rien laisser paraître. » « Je me débrouille seul. » « Personne n’a à me dire quoi faire. »"],
     ["Croyances expansives", "« Ma valeur est entière, même sans performance. » « Je peux m’accorder le droit à l’erreur. » « Je peux montrer ma sensibilité sans perdre ma dignité. » « Je peux accueillir l’autre sans perdre mon espace. » « Je peux dire ce que je ressens avec justesse, sans me durcir ni écraser l’autre. »"],
     ["Axe de reconnexion", "Se reconnecter à sa capacité de discernement."],
     ["Incarner son plein potentiel", "Quand cette blessure s’apaise, l’être peut incarner la justesse, l’intégrité, la vérité, la droiture, la clarté intérieure et une exigence saine. La personne devient capable de garder sa structure sans se fermer, de rester digne sans se durcir, d’être précise sans devenir froide, et de tenir un cadre avec profondeur et humanité."],
     ["Guérison", "Quand la blessure d’injustice s’apaise, la personne se reconnecte davantage à son corps, se relâche, se montre moins perfectionniste, supporte mieux l’imperfection et ressent moins le besoin de tout retenir. Elle ose davantage exprimer ce qu’elle vit, avec plus de souplesse, moins de froideur et moins de tension intérieure."],
   ],
  },
